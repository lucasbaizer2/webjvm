use super::jvm::Jvm;
use crate::{
    model::{CallStackFrame, CallStackFrameState, JavaArrayType, JavaValue, JavaValueVec},
...
impl<'a> JniEnv<'a> {
    ...
    pub fn get_string(&self, str_id: usize) -> String {
        ...
        let value_array = obj.get_field(self.jvm, "value");
        match value_array {
            JavaValue::Array(ptr) => {
                let heap = self.jvm.heap.borrow();
    ...
    pub fn set_field(&self, instance_id: usize, field_name: &str, value: JavaValue) {
        ...
        obj.set_field(self.jvm, field_name, value);
    }
    ...
    pub fn get_field(&self, instance_id: usize, field_name: &str) -> JavaValue {
        ...
        let obj = heap
            ...
            .get(&instance_id)
            .expect("invalid instance ID");
        obj.get_field(self.jvm, field_name).clone()
    }
    ...
    fn invoke_method(
        ...
        let mut frame = self.jvm.create_stack_frame(method_class, method);
        let mut index = 0;
    ...
    pub fn invoke_static_method(
        ...
        let (method_class, method) = self
            .jvm
            .classpath
            .get_method(InvokeType::Static, class, method_name, method_descriptor)
            .unwrap_or_else(|| {
                self.jvm.throw_exception(
...
pub fn initialize(jvm: &Jvm) {
    ...
    for cls in &required_classes {
        jvm.ensure_class_loaded(cls, true);
    }
