use crate::{Classpath, JniEnv, model::JavaValue};

#[allow(non_snake_case)]
fn Java_sun_reflect_Reflection_getCallerClass(env: &JniEnv) -> Option<JavaValue> {
    ...
    Some(JavaValue::Object(Some(class_obj)))
}
